...
TEXT = '''Представь, что ты автор курса по программированию микроконтроллеров на Си. Напиши вопросы к теме "Переключатель switch-case". Должно быть 10 заданий тестовых на выбор одного правильного ответа, а также 5 на сортировку или сопоставление. Ответ представь в формате json по образцу:{
    "choice": [
    {
        "text": "Text question",
        "correct": ["correct"],
...
PATH = "projects/009_switch-case.yaml"
